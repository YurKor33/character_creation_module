...
# Из модуля start_game_banner, из папки graphic_arts,
...
def defence(char_name: str, char_class: str) -> str:
    """Defense command processing function."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Workout start processing function."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Character selection processing function."""
